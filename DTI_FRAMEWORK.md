...
3. **The 4 Hard Gates (Mechanical Overrides):**
   ...
   * **The Suppression Gate (Oppression Quarantine $\rightarrow$ Min Bracket 4):** Any deck deploying hard asymmetric locks or total resource denial ($I2 = S$, such as *Winter Orb*, *Static Orb*, *Stasis*, or early hard lockouts) is quarantined to Bracket 4. High-powered recurring attrition ($I2: A$, such as *Maha, Its Feathers Night* + sweepers, *Archon of Cruelty*, or *Grave Pact* engines) contributes 4 points to Threat Score and elevates the Suppression Vector (e.g. 20/40), but remains 100% legal in Bracket 3 as long as the deck's aggregate Threat Score stays within the Bracket 3 band ($\le 51/96$).
...
| **Final Bracket** | **Bracket 3 (Upgraded Casual — Apex)** | **Bracket 3 (Upgraded Casual — Apex Ceiling)** | **Bracket 3 (Upgraded Casual — Solid)** | **Bracket 3 (Upgraded Casual — Precon Floor)** | **Bracket 2 (Core / Precon — Apex Ceiling)** | **Bracket 3 (Upgraded Casual — Explosive Stompy)** | **Bracket 3 (Upgraded Casual — Exact Floor)** | **Bracket 3 (Upgraded Casual — Exact Floor)** | **Bracket 3 (Upgraded Casual — Solid)** | **Bracket 3 (Upgraded Casual — Solid)** | **Bracket 3 (Upgraded Casual — Game Changer Floor)** | **Bracket 4 (Optimized — WotC MLD Floor)** |
| **DTI Threat Score** | **50 / 96** (B3 band: 32–51) | **50 / 96** (B3 band: 32–51) | **46 / 96** (B3 band: 32–51) | **40 / 96** (B3 band: 32–51) | **31 / 96** (B2 band: 16–31) | **40 / 96** (B3 band: 32–51) | **32 / 96** (B3 band: 32–51) | **32 / 96** (B3 band: 32–51) | **37 / 96** (B3 band: 32–51) | **41 / 96** (B3 band: 32–51) | **31 / 96** (B2 band: 16–31; promoted to B3 via 3 Game Changers) | **42 / 96** (B3 band: 32–51; promoted to B4 via Blood Moon MLD) |
