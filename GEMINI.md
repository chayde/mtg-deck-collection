...
Before adding any card, cross-reference the "Game Changers" list in `COMMANDER_DECKBUILDING_RULES.md` and verify it dynamically via Scryfall using `python scripts/scryfall_lookup.py "Card Name"`:
