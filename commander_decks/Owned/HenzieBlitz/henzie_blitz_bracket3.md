...
# Deck Guide: Henzie "Toolbox" Torre — "Blitz & Reanimation Engine"
...
1.  **Turn 1–2 (Velocity Setup):** Prioritize opening hands with at least one 1-CMC mana dork (*Birds of Paradise*, *Delighted Halfling*, *Ignoble Hierarch*, *Elves of Deep Shadow*, *Llanowar Elves*, *Fyndhorn Elves*, *Elvish Mystic*, *Orcish Lumberjack*). Deploy Henzie on Turn 2.
2.  **Turns 3–4 (Establish Value Loops):** Blitz 4-CMC and 5-CMC value generators (*Seedguide Ash*, *Atsushi*, *Blossoming Tortoise*, *Druid of Purification*, *Primeval Herald*, *Solemn Simulacrum*). Attack immediately, deal combat damage, and sacrifice at end of turn to draw into fuel while setting up *Birthing Ritual* or *Survival of the Fittest*.
3.  **Turns 5–7 (Overwhelming Incursion):** Blitz high-impact game-enders (*Archon of Cruelty*, *Terror of the Peaks*, *Etali, Primal Conqueror*, *Moraug, Fury of Akoum*, *Ojer Kaslem*, *Massacre Wurm*). Reanimate entire graveyards with *Living Death* or loop recursion with *Chainer, Nightmare Adept* to close out the game without requiring infinite combos.
...
*   **Ignoble Hierarch:** {G} 0/1 exalted. Taps for {B}, {R}, or {G} and provides Exalted combat buff.
*   **Elves of Deep Shadow:** {G} 1/1. Taps for {B} at the cost of 1 life; crucial black mana fixing.
...
*   **Bloodstained Mire:** Fetch land (Swamp/Mountain).
*   **Verdant Catacombs:** Fetch land (Swamp/Forest).
*   **Windswept Heath:** Fetch land (Forest).
*   **Polluted Delta:** Fetch land (Swamp).
*   **Arid Mesa:** Fetch land (Mountain).
*   **Marsh Flats:** Fetch land (Swamp).
*   **Overgrown Tomb:** Shock land (Swamp/Forest).
*   **Stomping Ground:** Shock land (Mountain/Forest).
*   **Blood Crypt:** Shock land (Swamp/Mountain).
*   **Ziatora's Proving Ground:** Triome land (Swamp/Mountain/Forest) with Cycling {3}.
...
*   **Karplusan Forest:** Pain land ({R}/{G}).
*   **Sulfurous Springs:** Pain land ({B}/{R}).
...
*   **Apex Altisaur:** {7}{G}{G} 10/10 dinosaur. ETB and enrage trigger fight up to one target creature you don't control. When blitzed for 8 mana, it chains fights across opposing boards like a creature-based sweeper; even if it dies during the fight chain, blitz still grants the card draw. If it survives, it attacks for 10 haste into the cleared board and sacrifices at end step to draw and fuel reanimation. Combines with *Maha, Its Feathers Night* (opponents have 1 toughness) to wipe boards taking negligible damage, or *Mikaeus, the Unhallowed* to return via Undying and restart the entire fight chain.
...
- **2026-08-31:** Comprehensive Bracket 3 Overhaul & Comparative Research Integration.
    ...
    - **Reason:** Upgraded deck from baseline Bracket 2 budget build to a high-synergy Bracket 3 powerhouse based on mathematical analysis of high-power Henzie lists and primers. Maximize Turn 2 Henzie deployment, high-velocity sacrifice engines, and non-combo reanimation finishers.
