...
*   **Rogue's Passage:** Redundant unblockable source.
*   **Mount Doom:** Flavorful damage and emergency wipe.
*   **Fetch Lands:** Polluted Delta, Bloodstained Mire, Scalding Tarn.
*   **Shock Lands:** Watery Grave, Steam Vents, Blood Crypt.
*   **Bond Lands:** Morphic Pool, Luxury Suite, Training Center.
*   **Check Lands:** Drowned Catacomb, Dragonskull Summit, Sulfur Falls.
*   **Slow Lands:** Shipwreck Marsh, Haunted Ridge, Stormcarved Coast.
*   **Utility Lands:** Takenuma, Abandoned Mire.
*   **Duals:** Sunken Hollow, Smoldering Marsh, Shivan Reef, Sulfurous Springs, Underground River.
*   **Rainbow/Command:** Command Tower, Exotic Orchard.
*   **Basics:** 6 Swamp, 4 Island, 2 Mountain.
...
*   **Warren Soultrader ({2}{B}):** **ELITE ARTIFACT & MANA ENGINE.** Since you are constantly Amassing a single Orc Army token, you can sacrifice it to the Soultrader to create a Treasure at any time (for just 1 life). You can then Amass a new 1/1 token immediately with any trigger, effectively turning your "excess" Amass triggers into mana and triggering "dies" or "leaves the battlefield" effects.
*   **Withering Torment ({2}{B}):** **CRITICAL INTERACTION.** A rare Black instant that can destroy either a creature or an **enchantment**. Grixis notoriously struggles with problematic enchantments (like *Rest in Peace* or *Smothering Tithe*); this provides a versatile answer that fits perfectly into your removal suite.
*   **Cavern-Hoard Dragon ({7}{R}{R}):** **EXPLOSIVE RAMP & THREAT.** In Commander, this frequently costs only {R}{R} due to opponents' mana rocks. It has Flying and Haste, and whenever it deals combat damage to a player, you create Treasures equal to the number of artifacts they control. It’s a massive flavor win that provides the mana needed to cast Sauron multiple times if he's targeted.

---

## 📈 Priority Upgrade List (Remaining Orders)

*All planned upgrades have been physically integrated!*
