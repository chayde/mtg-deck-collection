...
![Etali, Primal Conqueror](https://cards.scryfall.io/normal/front/9/5/95c14c4d-6c16-4826-8d93-d89ad04aee09.jpg?1783916997)
...
*   **Sol Ring:** One mana for two. The single most important accelerant in the format.
*   **Talisman of Impulse:** Two mana, taps for green or red (with 1 life for off-color). Faster than a Signet in terms of mana return.

### 🌾 Land Enchantments (2 Cards)
*   **Utopia Sprawl:** Enchant a Forest to produce an additional mana of any chosen color. Turns a Forest into a dual-producing land for the rest of the game — effectively a one-mana ramp spell that keeps generating value.
*   **Wild Growth:** Enchant any land for +1 mana. Even simpler than Utopia Sprawl but just as effective in the early turns.

### ⚡ Burst Mana & Cost Reduction (8 Cards)
*   **Frontier Siege:** Choose Khans at the beginning of your upkeep — add {G}{G} during each of your two main phases every turn. That's 4 free mana per turn cycle, permanently, toward Etali recasts, commander tax, or copy effects. Unlike burst mana it doesn't require setup or timing — it just produces every turn from the moment it lands.
...
*   **Chandra, Flameshaper:** Her {-3} creates a hasty token copy of any creature you control until end of turn. A planeswalker that acts as a repeatable on-demand Etali copy every time she ticks up to loyalty 3.
*   **Cursed Mirror:** ETBs as a hasty copy of any creature on the battlefield — the copy's ETB fires immediately, stealing spells before Cursed Mirror reverts to a mana rock on your next upkeep. Free ETB trigger the turn it enters.
*   **Delina, Wild Mage:** When she attacks, roll a d20 targeting a creature. On 15–19, create a hasty token copy of it. On 20+, create the copy and roll again. Etali at a 15+ result generates another ETB chain and the 20+ can cascade into multiple triggers.
*   **Electroduplicate:** Create a hasty token copy of a creature you control. Simple, direct, and cheap at two mana — another Etali ETB on demand.
*   **Flameshadow Conjuring:** Whenever a nontoken creature ETBs, pay {R} to create a hasty token copy of it until end of turn. A permanent enchantment that turns every creature entry into a potential Etali ETB for just one red mana.
*   **Heat Shimmer:** Create a hasty token copy of any creature until end of turn. Instant-speed — can be used on opponents' end steps to set up an Etali ETB going into your attack phase.
...
### 🔁 ETB Doubler (1 Card)
*   **Panharmonicon:** Creature and artifact ETB triggered abilities trigger an additional time. Etali's ETB fires twice — instead of one nonland card per opponent, you exile and cast two per opponent. In a four-player pod each Etali entry steals six spells instead of three. Every other ETB creature in the deck also doubles.
...
### 🗡️ Removal & Interaction (3 Cards)
*   **Beast Within:** Destroy any permanent, the owner gets a 3/3 Beast token. Universal instant-speed answer — hits artifacts, enchantments, planeswalkers, lands, and creatures. The 3/3 token is irrelevant when you have multiple 7/7 dinosaurs on the board.
*   **Blasphemous Act:** Costs {1} with enough creatures in play — deals 13 damage to all creatures. The best red board wipe in the format. Reset the board when opponents develop faster than you.
*   **Chaos Warp:** Shuffle target permanent into its owner's library, that player reveals the top card — if it's a permanent it ETBs. Red's best answer to problematic enchantments and indestructible permanents that other removal can't handle.

### 🏆 Value Engines & Win Conditions (7 Cards)
*   **Eternal Witness:** ETB returns any card from your graveyard to your hand. Recover a countered Etali, a destroyed Helm of the Host, or any key piece lost to removal. The best recursive value creature in green.
*   **Etali, Primal Storm:** The original Etali ({4}{R}{R}{G}) fires its trigger on **attack** (not ETB), layering additional spell theft on top of Etali Conqueror's ETBs. A 6/6 with trample that creates a second trigger window. Garruk's Uprising and Swiftfoot Boots ensure she connects with trample + haste.
...
*   **Solemn Simulacrum:** ETB fetches any basic land to the battlefield tapped and draws a card when it dies. Each copy effect that duplicates Sad Robot fetches another land AND draws another card on death. Bridges the early game into Etali and generates ongoing value throughout.
...
### ⚠️ Bracket Calibration Notes
*   **Mana Geyser** and **Selvala, Heart of the Wilds** both appeared only in Bracket 3 EDHREC lists. They are not Game Changers and are legal at any bracket, but they push this deck toward the high end of Bracket 2. If your pod finds the deck too fast, these are the first cards to discuss removing — candidates to replace them are **Harrow** and **Solemn Simulacrum**.
...
*   **2026-03-19:** Swapped Nalfeshnee and Rionya, Fire Dancer for Solemn Simulacrum and Frontier Siege.
    ...
    *   **Reason:** Budget reduction pass. Nalfeshnee ($10) replaced by Solemn Simulacrum ($1) — ramp + draw that multiplies with copy effects. Rionya ($10) replaced by Frontier Siege ($0.50) — conditional copy effect out, permanent 4 mana per turn in.
...
*   **2026-03-19:** Full rebuild from "Primal Budget Blitz" (extreme budget $25 list) to "Primal Dominion" (Ramp + Clones strategy). Built from cross-reference of four EDHREC average decklists: Bracket 2 Ramp, Bracket 3 Ramp, Bracket 2 Clones, Bracket 3 Clones. Previous file archived as `etali_primal_conqueror.md` (deck_status: reference).
    ...
    *   **Reason:** Complete strategic overhaul. Prior deck was one-dimensional (ramp Etali, hope she sticks). New build is a Ramp + Clones hybrid with 15 dedicated copy effects, 6 protection pieces, and a consistent ETB chain engine. Constructed from cross-referencing four EDHREC average decklists across brackets and strategies to find consensus staples.
*   **2026-03-16:** Scryfall audit and initial corrections on prior budget build.
*   **2026-03-16:** Initial deck creation from $25 extreme budget online decklist.
