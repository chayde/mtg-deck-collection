...
**Notes:**
- **Velocity & Curve Stability:** 90% commander deployment rate with average cast turn of T3.9 (50% cast on or before T3 via 1-drop mana dorks and 2-drop ramp spells).
- **Mulligan Quality:** 56% Gold keeps and 44% Silver keeps (**100% functional opening hands with 0% desperation keeps**) and an average starting hand size of 6.94 cards.
- **Engine Readiness:** 79% of seats achieve full engine readiness on or before Turn 7 (Average T4.7), aligning with the Bracket 3 expected window.
- **HTML Report:** Comprehensive dashboard written to `goldfish_report_20260821_193800.html`.
