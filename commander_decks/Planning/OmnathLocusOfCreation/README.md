...
![Omnath, Locus of Creation](https://cards.scryfall.io/normal/front/4/e/4e4fb50c-a81f-44d3-93c5-fa9a0b37f617.jpg?1783929320)
...
Omnath triggers **once per turn** for each land that enters the battlefield:
1.  **First Land:** Gain 4 life.
2.  **Second Land:** Add {R}{G}{W}{U}.
3.  **Third Land:** Deal 4 damage to each opponent and each planeswalker you don't control.

---

## 🛠️ Card Explanations

### 🌍 The Core Engine: Extra Land Drops (10)
*These are the most important cards for enabling your strategy. Their goal is to let you play multiple lands per turn to trigger Omnath repeatedly.*
...
### 🏆 The Payoffs: Landfall Win Conditions (14)
...
*A high-power mana base built for both color fixing and landfall triggers.*
...
*   **2026-03-25:** Updated deck format to match current standards (emoji sections, card counts).
